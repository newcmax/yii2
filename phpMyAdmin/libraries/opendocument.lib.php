...
function PMA_createOpenDocument($mime, $data)
{
    ...
    $zipfile -> addFile(
        ...
        . '<style:page-layouts style:name="pm1">'
        . '<style:page-layouts-properties fo:page-width="8.2673in"'
        ...
        . '</style:page-layouts-properties>'
        . '<style:header-style/>'
        . '<style:footer-style/>'
        . '</style:page-layouts>'
        . '</office:automatic-styles>'
        . '<office:master-styles>'
        . '<style:master-page style:name="Standard" style:page-layouts-name="pm1"/>'
        . '</office:master-styles>'
